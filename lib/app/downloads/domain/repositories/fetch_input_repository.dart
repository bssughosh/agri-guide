abstract class FetchInputRepository {
  ...
  /// particular state ID and district ID present in the repository
  Future<List> getSeasons(String state, String district);

  /// A function which returns a list of crops for a
  /// particular state ID, district ID and season present
  /// in the repository
  Future<List> getCrops(String state, String district, String season);
